...
const testimonials = [
  {
    ...
    location: "CDMX",
    rating: 5,
    text: "La calidad de impresión es increíble. Los colores se ven exactamente como en mi diseño original.",
    product: "Camiseta Clásica"
  },
  {
    id: 2,
    name: "Ana L.",
    ...
    rating: 5,
    text: "Pedí sudaderas para mi marca y quedaron perfectas. El proceso fue súper fácil y rápido.",
  ...
  },
  {
    ...
    location: "Monterrey",
    rating: 5,
    text: "La tela es de muy buena calidad y la impresión no se desvanece con las lavadas. Muy recomendable.",
  ...
  },
  {
    ...
    location: "Querétaro",
    rating: 5,
    text: "El empaque llegó perfecto y la gorra bordada superó mis expectativas. Definitivamente volveré a pedir.",
    product: "Gorra Snapback"
  },
  {
    id: 6,
    name: "Laura P.",
    location: "Mérida",
    rating: 5,
    text: "Compré tote bags personalizados para mi negocio. La calidad del algodón y la impresión son excelentes.",
    product: "Tote Bag"
  },
  {
    id: 7,
    ...
    location: "León",
    rating: 5,
    text: "La camiseta oversize tiene un corte increíble. La tela es suave y la impresión DTG quedó perfecta.",
    product: "Camiseta Oversize"
  },
  {
    id: 8,
    ...
    location: "Cancún",
    rating: 5,
    text: "Me encanta que puedo crear diseños únicos sin mínimos de pedido. Ideal para mi tienda en línea.",
    product: "Manga Larga"
  },
  {
    id: 9,
    ...
    location: "Tijuana",
    rating: 5,
    text: "El envío fue más rápido de lo esperado y las camisetas son de muy buena calidad. Excelente relación precio-calidad.",
    product: "Camiseta Clásica"
  }
]
